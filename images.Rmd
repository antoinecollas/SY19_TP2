...
model %>%
  ...
  layer_conv_2d(filter = 16, kernel_size = c(3,3), padding = "same", strides = c(2, 2)) %>%
  layer_activation("relu") %>%
  layer_conv_2d(filter = 16, kernel_size = c(3,3), padding = "same") %>%
  layer_activation("relu") %>%
  layer_dropout(0.5) %>%
  
  layer_conv_2d(filter = 32, kernel_size = c(3,3), padding = "same", strides = c(2, 2)) %>%
  layer_activation("relu") %>%
  ...
  layer_conv_2d(filter = 64, kernel_size = c(3,3), padding = "same", strides = c(2, 2)) %>%
  layer_activation("relu") %>%
