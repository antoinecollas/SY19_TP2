...
astronomy_train <- cbind(data.frame(scale(astronomy_train[,-which(names(astronomy_train)=="y")], center = TRUE, scale = TRUE)), astronomy_train[,which(names(astronomy_train)=="y")])
