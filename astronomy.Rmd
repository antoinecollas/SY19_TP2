...
knitr::kable(res)
```
L'analyse discriminante quadratique est l'algorithme le plus performant des trois modèles testés précédemments. Les modèles plus complexes fonctionnent donc bien sur ce jeu de données. Nous testons donc SVM avec différents noyaux.
...
#noyau polynomial
hyperparametres <- list(kernel="polydot", kpar=list(degree=which.min(erreurs_degres)), C=C)
